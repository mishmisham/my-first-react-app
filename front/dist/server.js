...
const UserItem = ({
  ...
  const {
    data
  } = (0,_apollo_client__WEBPACK_IMPORTED_MODULE_2__.useSuspenseQuery)(USER_QUERY, {
    variables: {
      id
    }
  });
  console.log(data);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, "sssssss");
};
const PageSecond = () => {
